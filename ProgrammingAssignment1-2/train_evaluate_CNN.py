...
def train(model, device, train_loader, optimizer, criterion, epoch, batch_size):
    ...
    # Loop through test_loader and compare prediction with value.
    with torch.no_grad():
        samples = 0
        correct = 0
...
def run_main(FLAGS):
    ...
    # Cross Entropy Loss function used from torch.nn
    criterion = nn.CrossEntropyLoss()
    ...
    plt.axis([0, FLAGS.num_epochs, 0, 4])
    ...
    for epoch in range(1, FLAGS.num_epochs + 1):
        ...
        plt.scatter(epoch, train_accuracy)
